...
if(!isset($_SESSION['id'])){
	...
	echo 'Nome:<br><input type="text" name="name" placeholder="Digite seu nome inteiro:	">';
	echo '<span class="error" style="color: red; font-size: 0.8em;"><?php echo $nameErr;?></span><br><br>';

	echo 'CPF:<br><input type="text" name="ic" placeholder="xxxxxxxxxx-xx">';
	...
	echo ' Digite seu número:<br><input type="text" name="contact" placeholder="0123456789">';
	echo '<span class="error" style="color: red; font-size: 0.8em;"><?php echo $contactErr;?></span><br><br>';

	echo '<label>Gênero:</label><br>';
	echo '<input type="radio" name="gender" if (isset($gender) && $gender == "Male") echo "checked"; value="Male">Masculino';
	echo '<input type="radio" name="gender" if (isset($gender) && $gender == "Female") echo "checked"; value="Female">Femenino';
	echo '<input type="radio" name="gender" if (isset($gender) && $gender == "Prefiro não comentar") echo "checked"; value="Prefiro não comentar">Prefiro não comentar';
	echo '<span class="error" style="color: red; font-size: 0.8em;"><?php echo $genderErr;?></span><br><br>';

	echo '<label>Digite seu endereço:</label><br>';
	   echo '<textarea name="address" cols="30" rows="5" placeholder="Endereço."></textarea>';
